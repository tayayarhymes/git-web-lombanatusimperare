 ...
 */
function ystudy_education_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function ystudy_education_sanitize_css( $css ) {
 ...
 */
function ystudy_education_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function ystudy_education_sanitize_image( $input, $setting ) {
	return esc_url_raw( ystudy_education_validate_image( $input, $setting->default ) );
}
...
function ystudy_education_validate_image( $input, $default = '' ) {
 ...
 */
function ystudy_education_sanitize_number_absint( $number, $setting ) {
 ...
 */
function ystudy_education_sanitize_select( $input, $setting ) {
 ...
 * @return int
 */
function ystudy_education_sanitize_category($input){
	$output=intval($input);
	return $output;
}
